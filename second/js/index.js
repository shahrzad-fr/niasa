...
////////////////// processtab script
const selectTab = function (tabIndex) {
  ...
  const tabActive = document.getElementById(`tab` + tabIndex);
  tabActive.classList.add(`active`);
};

// transtion animation section
function reveal() {
...
$(document).ready(function () {
  ...
  var accordionQuestionClass = '.title';
  ...
  $(accordionQuestionClass).click(function () {
    ...
    if (faqClass.indexOf('close') != -1) {
      //WHEN CLOSED
      $(accordionParentClass).find(accordionContentClass).slideUp(0); //CLOSE ALL
      // fadeOut
...
// // /// store last slideIndex
// function showSlides(n) {
//   let slides = document.getElementsByClassName('mySlides');
//   let dots = document.getElementsByClassName('dot');

//   ///first way loop slides -- display all slides none
//   for (let i = 0; i < slides.length; i++) {
//     slides[i].style.display = 'none';
//   }

//   ///second way loop slides
//   // Array.prototype.forEach.call(slides, child => {
//   //   child.style.display = `none`;
//   // });

//   ///thierd way loop slides
//   // let slides = document.querySelectorAll('.mySlides');
//   // slides.forEach(item => {
//   //   item.style.display = 'none';
//   // });

//   ////when we are in first slide and press perv key (-)
//   if (n < 1) {
//     slideIndex = slides.length;
//   }
//   ///when we are in last slid and press next key (+)
//   if (n > slides.length) {
//     slideIndex = 1;
//   }
...
//   /// remove active class from all--first way loop dots
//   for (let i = 0; i < dots.length; i++) {
//     dots[i].className = dots[i].className.replace(' active', '');
//   }
//   ///second way loop dots
//   // Array.prototype.forEach.call(dots, child => {
//   //   child.className = child.className.replace(' active', '');
//   // });

//   ///thierd way loop dots
//   // let dots = document.querySelectorAll('.dot');
//   // dots.forEach(item => {
//   //   item.className.replace(' active', '');
//   // });

//   /////add activ class to current slide
...
// /888****************************slider-super-1
var swiper = new Swiper('.mySwiper-super-1', {
  // slidesPerView: 4,
  // spaceBetween: 10,
  pagination: {
...
////////////////// choosetab script
const chooseTab = function (tabIndex) {
  const tabContent = document.querySelectorAll(`.choose-content`);
  tabContent.forEach(item => {
    item.style.display = 'none';
  });
  document.getElementById(
    `choose` + tabIndex + `content`
  ).style.display = `block`;
  /////////Show the Selected Tab
  const tab = document.querySelectorAll(`.choose-tab`);
  tab.forEach(item => {
    item.classList.remove('blue');
  });
  const tabActive = document.getElementById(`choose` + tabIndex);
  tabActive.classList.add(`blue`);
};

/////////////////////////////submenu

// open and close submenu whith click
...
//open and close submenu whith hover
// $(document).ready(function () {
//   $('.menu').hover(
//     function () {
...
const menuselect = function (tabIndex) {
  /////////Show the Selected Tab
  const tab = document.querySelectorAll(`.menuselect`);
  tab.forEach(item => {
